...
def filter_triturns(thresh=0.7):
    ...
    for i,tt in enumerate(triturns):
        a = data.iloc[tt]['line']
        b = data.iloc[tt+1]['line']
        c = data.iloc[tt+2]['line']
